...
function Navbar() {
  ...
  return (
    ...
    >
      {/* upper navbar */}
      <div className="h-[60%] flex items-center justify-between px-2 sm:px-4 md:px-6 bg-black bg-opacity backdrop-blur-sm shadow-gray-700 shadow-lg">
        {/* left side */}
        <div className="flex items-center gap-2 sm:gap-4">
          <img src={logo} alt="logo" className="h-12 w-12 sm:h-16 sm:w-16" />
          <div className="font-family-satisfy font-extrabold text-lg sm:text-2xl text-white">GLOWRIN</div>
          <div className="flex items-center bg-white border border-gray-300 rounded-full px-3 py-1 sm:px-4 sm:py-2 w-full max-w-[200px] sm:max-w-sm shadow-sm">
            <input
              type="text"
        ...
        {/* right side */}
        <div className="flex items-center gap-1 sm:gap-4 text-white text-xs sm:text-sm md:text-base">
